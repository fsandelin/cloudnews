...
test('getDaysForMonth gets correct number of days', () => {
  expect(helpers.getDaysForMonth(2018, 0)).toBe(31)
  expect(helpers.getDaysForMonth(2018, 1)).toBe(28)
  expect(helpers.getDaysForMonth(2018, 2)).toBe(31)
  expect(helpers.getDaysForMonth(2018, 3)).toBe(30)
  expect(helpers.getDaysForMonth(2018, 4)).toBe(31)
  expect(helpers.getDaysForMonth(2018, 5)).toBe(30)
  expect(helpers.getDaysForMonth(2018, 6)).toBe(31)
  expect(helpers.getDaysForMonth(2018, 7)).toBe(31)
  expect(helpers.getDaysForMonth(2018, 8)).toBe(30)
  expect(helpers.getDaysForMonth(2018, 9)).toBe(31)
  expect(helpers.getDaysForMonth(2018, 10)).toBe(30)
  expect(helpers.getDaysForMonth(2018, 11)).toBe(31)
})